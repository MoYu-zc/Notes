                    ...
                    <div id="menu-container">
                        <div id="menu-1" class="homepage home-section gallery-section">
                            <div class="box-content">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                    <form id="docaddform" action="docs_update.action" method="post" onsubmit="return checkAdd()">
                                    <input type="hidden" name="docs.id" value="${docs.id}"/>
                                    <input type="hidden" name="docs.doctime" value="${docs.doctime}"/>
                                    <input type="hidden" name="docs.status" value="${docs.status}"/>
                                    <input type="hidden" name="docs.isdel" value="${docs.isdel}"/>
                                    <input type="hidden" name="docs.user.id" value="${docs.user.id}"/>
                                    <table class="table table-bordered">
                                        <tr>
                                            <td width="15%">文档名称：</td>
                                            <td width="85%"><input style="width:500px" type="text" value="${docs.name}" class="name" id="name" name="docs.name" placeholder="文档名称..."></td>
                                        </tr>
                                        <tr>
                                            <td>文档标签：</td>
                                            <td>
                                            <input style="width:500px" type="text" value="${docs.tags}" class="name" id="tags" name="docs.tags" placeholder="文档标签...">(多个标签,隔开)
                                            <br/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
	                                			...
	                                			<input type="hidden" id="docpath" value="${docs.docpath}" name="docs.docpath"/> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>文档简介：</td>
                                            <td><textarea name="docs.shortcontent" id="shortcontent" style="width:500px" rows="3" placeholder="简介">${docs.shortcontent}</textarea></td>
                                        </tr>
                                        <tr>
                                            <td>文档内容：</td>
                                            <td><textarea id="content" name="docs.content" style="width:500px" rows="8" placeholder="内容">${docs.content}</textarea></td>
                                        </tr>
                                        <tr>
